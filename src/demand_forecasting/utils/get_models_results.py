...
def get_xgboost_results(global_data: GlobalData, preparated_data_dict: Dict[str, Union[str, pl.DataFrame]], 
                        model: str, model_objective: Callable, parameters: Dict[str, Any]) -> pl.DataFrame:
    """Get XGBoost model results.
    ...
    Returns:
        pl.DataFrame: DataFrame with the results for the XGBoost model.
    """

    start = time.time()
    
    objective = partial(model_objective, global_data=global_data, preparated_data_dict=preparated_data_dict, parameters=parameters)
...
def get_darts_results(global_data: GlobalData, preparated_data_dict: Dict[str, Union[str, pl.DataFrame]],
                      data_separators_dict: Dict[str, Union[List[int], Type[EWS]]], model: str, model_objective: Callable, 
                      parameters: Dict[str, Any]) -> pl.DataFrame:
    """Get model results from the Darts library.
    ...
    Returns:
        pl.DataFrame: DataFrame with the results for the Darts library model.
    """
